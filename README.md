...
> **Por que no se usa GitHub Pages:** GitHub Pages sirve unicamente archivos estaticos (HTML, CSS, JS).
...
>
> Es posible alojar el `index.html` en GitHub Pages como pagina de presentacion del proyecto,
> pero la aplicacion completa (registro, login, base de datos) necesita un servidor real.
